# Generated by Django 3.2.12 on 2022-02-06 10:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('aliases', models.CharField(blank=True, max_length=200, null=True, verbose_name='Other names for the brand, comma seperated. i.e. BOFA, BOA')),
                ('display_on_website', models.BooleanField(default=False)),
                ('comment', models.TextField(verbose_name='Meta. Comments for staff and/or editors')),
                ('rating', models.CharField(max_length=6, verbose_name='Rating')),
                ('unique_statement', models.TextField(blank=True, null=True, verbose_name='Positive/Negative. i.e. Despite introducing policies to restrict unconventional oil and gas finance, BNP Paribas recently ')),
                ('headline', models.CharField(blank=True, max_length=200, null=True, verbose_name='Positive/Negative. i.e. #1 in Coal')),
                ('top_blurb_headline', models.TextField(verbose_name='Positive/Negative. i.e. Your money is being used to fund the climate crisis at an alarming rate.')),
                ('top_blurb_subheadline', models.TextField(verbose_name='Positive/Negative. i.e. According to the latest research*, in 2020 your bank was the 4th largest funder...')),
                ('snippet_1', models.TextField(blank=True, default='', help_text='Used to fill in templates', verbose_name='Negative. Custom fact about the brand.')),
                ('snippet_1_link', models.URLField(blank=True, default='', verbose_name='link to dirty deal 1 detauls')),
                ('snippet_2', models.TextField(blank=True, default='', help_text='Used to fill in templates', verbose_name='Negative. Custom fact about the brand.')),
                ('snippet_2_link', models.URLField(blank=True, default='', verbose_name='link to dirty deal 2 detauls')),
                ('snippet_3', models.TextField(blank=True, default='', help_text='Used to fill in templates', verbose_name='Negative. Custom fact about the brand.')),
                ('snippet_3_link', models.URLField(blank=True, default='', verbose_name='link to dirty deal 3 detauls')),
                ('top_three_ethical', models.BooleanField(default=False, verbose_name='Positive. Is this bank a top three bank?')),
                ('recommended_order', models.IntegerField(default=3, null=True, verbose_name='Positive. in case there are more recommended banks than can fit on the page, lower numbers are given priority')),
                ...
                ('from_the_website', models.TextField(verbose_name='Positive. used to to describe green banks in their own words')),
                ('checking_saving', models.BooleanField(default=False, verbose_name='Positive. does the bank offer checkings or savings accounts?')),
                ('checking_saving_details', models.CharField(blank=True, default='', max_length=100, verbose_name='Positive. Details on available checkings and savings accounts')),
                ('free_checking', models.BooleanField(default=False, verbose_name='Positive. does the bank offer free checkings?')),
                ('free_checking_details', models.CharField(blank=True, default='', max_length=100, verbose_name='Positive. Details on available free checkings')),
                ('interest_rates', models.CharField(blank=True, max_length=100, null=True, verbose_name='Positive. Details about offered interest rates')),
                ('free_atm_withdrawl', models.BooleanField(default=False, verbose_name='Positive. does the bank offer free ATM withdrawals?')),
                ...
                ('credit_cards_details', models.CharField(blank=True, max_length=100, null=True, verbose_name='Positive. Details on credit cards')),
                ('free_international_card_payment', models.BooleanField(default=False, verbose_name='Positive. does the bank offer free international card payments?')),
                ('free_international_card_payment_details', models.CharField(blank=True, max_length=100, null=True, verbose_name='Positive. Details on free international card payments')),
                ('brand', models.ForeignKey(blank=True, help_text='What brand is this comment associated with?', on_delete=django.db.models.deletion.CASCADE, related_name='commentary_brand', to='brand.brand')),
            ],
        ),
    ]
