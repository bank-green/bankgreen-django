    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tag', models.CharField(help_text=('the tag we use or this brand record at Bank.Green. ',), max_length=100, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checking_saving_details', models.CharField(blank=True, default='', help_text='Positive. Details on available checkings and savings accounts', max_length=100)),
                ('free_checking', models.BooleanField(default=False, help_text='Positive. does the bank offer free checkings?')),
                ('free_checking_details', models.CharField(blank=True, default='', help_text='Positive. Details on available free checkings', max_length=100)),
                ('interest_rates', models.CharField(blank=True, help_text='Positive. Details about offered interest rates', max_length=100, null=True)),
                ('free_atm_withdrawal', models.BooleanField(default=False, help_text='Positive. does the bank offer free ATM withdrawals?')),
                ('free_atm_withdrawal_details', models.CharField(blank=True, default='', help_text='Positive. Details on available free ATM withdrawals', max_length=100)),
                ...
                ('local_branches_details', models.CharField(blank=True, help_text='Positive. Details on local branches', max_length=100, null=True)),
                ('mortgage_or_loan', models.BooleanField(default=False, help_text='Positive. does the bank offer mortgage or loans?')),
                ('deposit_protection', models.CharField(blank=True, help_text='Positive. Details on deposit protection', max_length=100, null=True)),
                ('credit_cards', models.BooleanField(default=False, help_text='Positive. does the bank offer credit cards?')),
                ('credit_cards_details', models.CharField(blank=True, help_text='Positive. Details on credit cards', max_length=100, null=True)),
                ...
                ('free_international_card_payment_details', models.CharField(blank=True, help_text='Positive. Details on free international card payments', max_length=100, null=True)),
                ('brand', models.OneToOneField(help_text='What brand is this comment associated with?', on_delete=django.db.models.deletion.CASCADE, related_name='features', to='brand.brand')),
            ],
        ),
        migrations.CreateModel(
            name='Commentary',
            fields=[
                ...
                ('comment', models.TextField(blank=True, help_text='Meta. Comments for staff and/or editors')),
                ...
                ('top_blurb_headline', models.CharField(blank=True, help_text='Positive/Negative. i.e. Your money is being used to fund the climate crisis at an alarming rate.', max_length=200)),
                ('top_blurb_subheadline', models.CharField(blank=True, help_text='Positive/Negative. i.e. According to the latest research*, in 2020 your bank was the 4th largest funder...', max_length=500)),
                ...
                ('recommended_in', django_countries.fields.CountryField(blank=True, help_text='Positive. what countries will this bank be recommended in?', max_length=746, multiple=True)),
                ('from_the_website', models.TextField(blank=True, help_text='Positive. used to to describe green banks in their own words')),
                ('brand', models.OneToOneField(help_text='What brand is this comment associated with?', on_delete=django.db.models.deletion.CASCADE, related_name='commentary', to='brand.brand')),
            ],
        ),
    ]
