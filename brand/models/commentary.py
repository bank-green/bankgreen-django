...
class Commentary(models.Model):
    ...
    aliases = models.CharField(
        "Other names for the brand, comma seperated. i.e. BOFA, BOA", max_length=200, null=True, blank=True
    )
    ...
    headline = models.CharField("Positive/Negative. i.e. #1 in Coal", max_length=200, null=True, blank=True)
    ...
    snippet_1 = models.TextField(
        "Negative. Custom fact about the brand.", help_text="Used to fill in templates", blank=True, default=''
    )
    ...
    # Positive Commentary
    top_three_ethical = models.BooleanField("Positive. Is this bank a top three bank?", default=False)
    ...
    from_the_website = models.TextField('Positive. used to to describe green banks in their own words')

    # Banking Detail Inforamtion, mostly used for recommended banks
    checking_saving = models.BooleanField("Positive. does the bank offer checkings or savings accounts?", default=False)
    checking_saving_details = models.CharField(
        "Positive. Details on available checkings and savings accounts", max_length=100, blank=True, default=''
    )

    free_checking = models.BooleanField("Positive. does the bank offer free checkings?", default=False)
    ...
    free_atm_withdrawl = models.BooleanField("Positive. does the bank offer free ATM withdrawals?", default=False)
    free_atm_withdrawl_details = models.CharField(
        "Positive. Details on available free ATM withdrawals", max_length=100, blank=True, default=''
    )

    online_banking = models.BooleanField("Positive. does the bank offer online banking?", default=False)
    local_branches = models.BooleanField("Positive. does the bank offer local branches?", default=False)
    local_branhes_custom = models.CharField(
        "Positive. Details on local branches", max_length=100, null=True, blank=True
    )

    mortgage_or_loan = models.BooleanField("Positive. does the bank offer mortgage or loans?", default=False)
    ...
    credit_cards_details = models.CharField("Positive. Details on credit cards", max_length=100, null=True, blank=True)
    ...
    free_international_card_payment_details = models.CharField(
        "Positive. Details on free international card payments", max_length=100, null=True, blank=True
    )
