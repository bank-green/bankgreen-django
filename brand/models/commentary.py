...
class Commentary(models.Model):
    ...
    headline = models.CharField(help_text="Positive/Negative. i.e. #1 in Coal", max_length=200, null=True, blank=True)
    ...
    snippet_1_link = models.URLField(help_text="link to dirty deal 1 detauls", blank=True, default='')
    ...
    snippet_2_link = models.URLField(help_text="link to dirty deal 2 detauls", blank=True, default='')
    ...
    snippet_3_link = models.URLField(help_text="link to dirty deal 3 detauls", blank=True, default='')
    ...
    checking_saving_details = models.CharField(
        help_text="Positive. Details on available checkings and savings accounts", max_length=50, blank=True, default=''
    )

    free_checking = models.BooleanField(help_text="Positive. does the bank offer free checkings?", default=False)
    free_checking_details = models.CharField(
        help_text="Positive. Details on available free checkings", max_length=50, blank=True, default=''
    )

    interest_rates = models.CharField(
        help_text="Positive. Details about offered interest rates", max_length=50, null=True, blank=True
    )
    ...
    free_atm_withdrawl_details = models.CharField(
        help_text="Positive. Details on available free ATM withdrawals", max_length=50, blank=True, default=''
    )

    online_banking = models.BooleanField(help_text="Positive. does the bank offer online banking?", default=False)
    local_branches = models.BooleanField(help_text="Positive. does the bank offer local branches?", default=False)
    local_branches_details = models.CharField(
        help_text="Positive. Details on local branches", max_length=50, null=True, blank=True
    )

    mortgage_or_loan = models.BooleanField(help_text="Positive. does the bank offer mortgage or loans?", default=False)
    deposit_protection = models.CharField(
        help_text="Positive. Details on deposit protection", max_length=50, null=True, blank=True
    )

    credit_cards = models.BooleanField(help_text="Positive. does the bank offer credit cards?", default=False)
