...
class Brand(TimeStampedModel):
    ...
    permid = models.CharField(max_length=30, blank=True)
    ...
    viafid = models.CharField(max_length=30, blank=True)
    ...
    googleid = models.CharField(max_length=30, blank=True)
    ...
    rssd_hd = models.CharField(max_length=30, blank=True)
